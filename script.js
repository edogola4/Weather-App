...
const apiKey = "26b2430f405955f492e1f2e45fa3a8e6";
...
function news(){
  ...
  $.ajax({
    method : "GET",
    url : `https://newsapi.org/v2/everything?q=Apple&from=2023-10-01&sortBy=popularity&apiKey=26b2430f405955f492e1f2e45fa3a8e6`,
    success : (data) =>{
      console.log(data);
